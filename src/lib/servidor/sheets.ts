...
import { etiquetaEs, etiquetasEs } from '@/lib/opciones';

/**
 * Réplica en Google Sheets de las pestañas normalizadas del script original
 * (PAR, ALO, TRA, PSE, ALI) más una pestaña con la respuesta completa.
 */
